...
--
-- Name: acctphy phy fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY acctphy
    ADD CONSTRAINT "acctphy phy fk" FOREIGN KEY (npi, phyefdt) REFERENCES phy(npi, phyefdt);
...
--
-- Name: manord ord fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY manifestord
    ADD CONSTRAINT "manord ord fk" FOREIGN KEY (ord, ordefdt) REFERENCES ord(ord, ordefdt);


--
-- Name: medord  ord fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY medord
    ADD CONSTRAINT "medord  ord fk" FOREIGN KEY (ord, ordefdt) REFERENCES ord(ord, ordefdt);
...
--
-- Name: ord phy fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY ord
    ADD CONSTRAINT "ord phy fk" FOREIGN KEY (npi, phyefdt) REFERENCES phy(npi, phyefdt);
...
--
-- Name: orddiag ord fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY orddiag
    ADD CONSTRAINT "orddiag ord fk" FOREIGN KEY (ord, oefdt) REFERENCES ord(ord, ordefdt);
...
--
-- Name: result ord fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY result
    ADD CONSTRAINT "result ord fk" FOREIGN KEY (ord, ordefdt) REFERENCES ord(ord, ordefdt);
