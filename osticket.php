...
$config = array(
        'url'=>'http://172.30.1.101/',  // URL to site.tld/api/tickets.json
		'key'=>'A2C9D2B5802413161E8CB3887BC01B36 '  // API Key goes here
);
# NOTE: some people have reported having to use "http://your.domain.tld/api/http.php/tickets.json" instead.

if($config['url'] === 'http://172.30.1.101/api/tickets.json') {
...
$data = array(
    'name'      =>      'Test Name',  // from name aka User/Client Name
    'email'     =>      'test@test.com',  // from email aka User/Client Email
    ...
    'ip'        =>     '172.30.1.110', // Should be IP address of the machine thats trying to open the ticket.
